  ...
  return (
    <div>
      <div className="h-fit">
        ...
        <div className="flex flex-col items-center w-full justify-center relative top-[-100px]">
          <div className="rounded-full z-10 w-40">
            <img
          ...
          <div className="w-full p-2">
            <div className="name">
              <span className="text-white font-sans font-medium text-center text-4xl">
                Lê Đài
              </span>
            </div>
            <div className="describe mt-2">
              <span className="text-gray-400 font-sans font-medium text-center text-lg">
                Goodbye World
              </span>
            </div>
          </div>
